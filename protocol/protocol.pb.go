...
const file_protocol_proto_rawDesc = "" +
	"\n" +
	"\x0eprotocol.proto\x12\x11debuglet.protocol\"J\n" +
...
var file_protocol_proto_depIdxs = []int32{
	1,  // 0: debuglet.protocol.ControlMessage.hello:type_name -> debuglet.protocol.ExecutorHello
	2,  // 1: debuglet.protocol.ControlMessage.heartbeat:type_name -> debuglet.protocol.ExecutorHeartbeat
	3,  // 2: debuglet.protocol.ControlMessage.assignment:type_name -> debuglet.protocol.DebugletAssignment
	4,  // 3: debuglet.protocol.ControlMessage.noop:type_name -> debuglet.protocol.NoOp
	0,  // 4: debuglet.protocol.DispatcherCommand.type:type_name -> debuglet.protocol.DispatcherCommandType
	6,  // 5: debuglet.protocol.SessionMessage.dispatcher_cmd:type_name -> debuglet.protocol.DispatcherCommand
	7,  // 6: debuglet.protocol.SessionMessage.ready:type_name -> debuglet.protocol.DebugletReady
	8,  // 7: debuglet.protocol.SessionMessage.stdout:type_name -> debuglet.protocol.DebugletStdout
	9,  // 8: debuglet.protocol.SessionMessage.exit:type_name -> debuglet.protocol.DebugletExit
	5,  // 9: debuglet.protocol.DebugletDispatcher.ControlStream:input_type -> debuglet.protocol.ControlMessage
	10, // 10: debuglet.protocol.DebugletDispatcher.SessionStream:input_type -> debuglet.protocol.SessionMessage
	5,  // 11: debuglet.protocol.DebugletDispatcher.ControlStream:output_type -> debuglet.protocol.ControlMessage
	10, // 12: debuglet.protocol.DebugletDispatcher.SessionStream:output_type -> debuglet.protocol.SessionMessage
