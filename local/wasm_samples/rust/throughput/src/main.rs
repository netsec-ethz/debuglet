...
//
// Build:
//   make wasm SAMPLE_DIR=local/wasm_samples/rust/throughput
//
// Run:
//   go run ./cmd/user -wasm local/wasm_samples/rust/throughput/debuglet.wasm -- -addr 127.0.0.1:5201 -secs 5
